    ...
    public partial class v1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDislikePosts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserDislikePosts_AspNetUsers_CustomUserId",
                        column: x => x.CustomUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserDislikePosts_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserLikePosts_AspNetUsers_CustomUserId",
                        column: x => x.CustomUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1", 0, "2839428b-ea49-476c-8133-ad2e39bd657f", "CustomUser", "admin@gmail.com", true, null, true, null, null, "admin", "AQAAAAEAACcQAAAAELbDcH1+e61wmsw97zM/29lRIXfnRICIO74BUyiNfKN4PlYPHYLiH26abOL7atgpKA==", null, false, "4f2e929f-6bd9-48c1-ae86-45d79afea2ff", false, "Admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDislikePosts_CustomUserId",
                table: "UserDislikePosts",
                column: "CustomUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserDislikePosts_PostId",
                table: "UserDislikePosts",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_UserLikePosts_CustomUserId",
                table: "UserLikePosts",
                column: "CustomUserId");
